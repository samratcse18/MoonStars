...
<div class="lg:ml-[250px] ml-0 lg:pt-[60px] pt-0 lg:pb-0 pb-[60px]">
    <div class="flex justify-center text-white mb-[60px]">
        <div class="lg:w-[95%] w-[95%] flex justify-center items-center">
            <div class="lg:w-[90%] w-full bg-[#51236e] rounded-lg">
                <div>
                ...
                <div id="depositMenu" class="mt-4">
                    ...
                    <h1 class="ml-8">Deposit Amount: {{ session('total_deposit') }}</h1>
                            ...
                            ?>
                                <tr class=" border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <?php
                                        if($deposit->status == "pending"){
                                    ?>
                                    <td class="px-3 py-3 m-2 text-center cursor-pointer text-white bg-[#dc3545] hover:bg-[#ea1b30]">
                                        <a href='user_statement/cancel_deposit/{{ $deposit->id }}'><button>Cancel</button></a>
                                    </td>
                                    <?php
                                        }
                                        else{
                                    ?>
                                        <td class="px-3 py-3 m-2 text-center text-white bg-gray-600">
                                        <button disabled class=" ">Cancel disabled</button>
                                        </td>
                                    <?php
                                        }
                                    ?>
                ...
                <div id="withdrawMenu" class="hidden">
                    ...
                    <h1 class="ml-8">Withdraw Amount: {{ session('total_withdraw') }}</h1>
                    <div class=" overflow-x-auto p-6">
                        <table class="w-full text-sm text-left text-white dark:text-gray-400">
                            <thead>
                                <tr class=" border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            ?>
                                <tr class=" border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    ?>
                                    <td class="px-3 py-3 m-2 text-center cursor-pointer text-white bg-[#dc3545] hover:bg-[#ea1b30]">
                                        <a href='user_statement/cancel_withdraw/{{ $withdraw->id }}'><button>Cancel</button></a>
                                    </td>
                                    <?php
                                        }
                                        else{
