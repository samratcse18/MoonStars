<nav class="block lg:hidden border-b border-solid border-black fixed top-0 w-full z-10 bg-[#51236e] px-2 sm:px-4 py-1">
  <div class="flex justify-between items-center space-x-2 lg:px-[10%]">
    <div class="flex space-x-2">
      ...
      <a href="/"><p class="text-yellow-400">Moon <br>Stars</p></a>
        ...
        <a href="#support"><div class="flex justify-center items-center space-x-1 px-2 hover:bg-gray-600">
              <i class="fa fa-headset" style="font-size: 24px; color: #007bff;"></i>
              <h1 class="block py-2 text-white">Support</h1>
        </div></a>
  </div>
</nav>
