...
<div class="flex justify-center text-white">
    <div class="lg:w-[80%] w-[95%] flex justify-center items-center">
        <div class="lg:w-[60%] w-full bg-[#51236e] p-6 space-y-4 md:space-y-6  rounded-lg sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6 w-full" action="{{ route('admin_password_change_action')}}" method="post">
                            @csrf
                            <div>
                                <label for="oldpassword"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Old Password<span class="text-xl text-[#dc3545]">*</span></label>
                            ...
                            <div>
                                <label for="password"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">New Password<span class="text-xl text-[#dc3545]">*</span></label>
                            ...
                            <div>
                                <label for="cpassword"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm New Password<span class="text-xl text-[#dc3545]">*</span></label>
